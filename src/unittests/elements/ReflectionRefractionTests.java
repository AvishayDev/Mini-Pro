    ...
    public void twoSpheres() {
        ...
        scene.geometries.add( //
				new Sphere(new Point3D(0, 0, -50), 50) //
                        .setEmission(new Color(0,150,10),new Color(126,10,220)) //
		...
		Render render = new Render() //
				.setImageWriter(new ImageWriter("refractionTwoSpheres5", 500, 500)) //
				.setCamera(camera) //
	...
	public void twoSpheresOnMirrors() {
		...
		scene.geometries.add( //
				new Sphere(400, new Point3D(-950, -900, -1000)) //
						...
						.setMaterial(new Material().setKd(0.25).setKs(0.25).setShininess(20).setKt(0.5).setRadiusDG(10)),
		...
		scene.lights.add(new SpotLight(new Color(1020, 400, 400), new Point3D(-750, -750, -150), new Vector(-1, -1, -4),1) //
				.setKl(0.00001).setKq(0.000005));

		ImageWriter imageWriter = new ImageWriter("Test!!", 500, 500);
		Render render = new Render() //
