...
public class PolygonTests {
    ...
    public void findGeoIntersections() {
        ...
        // TC01: the ray intersect the polygon
        rayCheck = new Ray(new Vector(1,0,1),new Point3D(0,-0.5,0));
        assertEquals("POINT Ray intercet the Polygon dosent work", List.of(new GeoPoint(polygon,new Point3D(0.75d,-0.5d,0.75d))),polygon.findGeoIntersections(rayCheck));
        assertEquals("NUM Ray intercet the Polygon dosent work", 1,polygon.findIntersections(rayCheck).size());
